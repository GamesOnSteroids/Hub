...
class GameDescription extends React.Component {
    ...
    render() {
        return (React.createElement("div", {style: { padding: "5px" }}, React.createElement("h3", {style: { backgroundColor: "#eee", padding: "0" }, className: "text-center"}, this.props.game.name), React.createElement("div", null, React.createElement("div", null, React.createElement("img", {width: "128", src: "app/games/" + this.props.game.id + "/assets/images/logo.png"})), React.createElement("div", {className: "pull-right"}, React.createElement("div", {className: "btn-group-vertical", role: "group"}, this.props.game.variants
