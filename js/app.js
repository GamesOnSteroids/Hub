...
class LobbyComponent extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", null, React.createElement("div", {"className": "row"}, React.createElement("div", {"className": "col-md-8"}, React.createElement("div", {"className": "row"}, React.createElement("div", {"className": "col-md-12"}, React.createElement("div", {"className": "progress"}, React.createElement("div", {"className": "progress-bar progress-bar-striped active", "role": "progressbar", "aria-valuenow": "100", "aria-valuemin": "0", "aria-valuemax": "100", "style": progressBarStyle}, React.createElement("span", null, "Searching for players"))))), React.createElement("div", null, React.createElement("div", {"className": "row"}, React.createElement("div", {"className": "col-md-12"}, React.createElement("div", null, "Player 1"), React.createElement("div", null, "Player 2"))))), React.createElement("div", {"className": "col-md-4"}, React.createElement("div", null, React.createElement("textarea", {"className": "form-control"}), React.createElement("div", {"className": "input-group"}, React.createElement("input", {"type": "text", "className": "form-control", "placeholder": "Text input"}), React.createElement("span", {"className": "input-group-btn"}, React.createElement("button", {"className": "btn  btn-primary btn-block glyphicon glyphicon-envelope"}))))))));
    }
}
